  ...
  <body>
    <div class="row" style="display: flex; justify-content: center;">
      <div class="col-lg-6 text-center">
        <div class="card">
          <div style="height:200px; width:200px; border-radius: 30px; background: #F8FAF5; margin:0 auto;">
          <div class="checkmark" style="color:#88B04B;font-size:140px;"><span>✓</span></div>
          </div>
          <h1>Success</h1> 

          <?php
            echo "<h3>Thank You. We received your mail.</h3>";
          ?>
            <a href="index.php" style="color:white;" class="btn btn-primary">GO TO HOME</a>
        </div>
      </div>
    </div>
  </body>
